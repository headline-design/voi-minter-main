...
window.defaultJSON = {
  name: 'VRC Logo',
  description: 'VRC Logo for VRC Minter by HEADLINE',
              ...
              <div className="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-3">
                ...
                >
                  ...
                  <h6 className="MuiTypography-root jss11 MuiTypography-subtitle1">
                    Learn how to mint VRC NFTs today!
                  </h6>
                </div>
              </div>
            </div>
                  ...
                  <div className="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-3">
                    <div className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-md-6">
                      ...
                      <div className="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-2">
                        <div className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                          ...
                          <p className="jss83">What is an VRC NFT?</p>
                          <p className="jss36">
                            VRC NFTs are NFTs minted on Voi Network that adhere to a standard that is
                            submitted as a Voi Request for Comment to the community. The goal
                            ...
                            the properties of a given VSA.
                            <br></br>
                            <br></br>
                            Below you will find instructions for minting VRC19 and VRC69 NFTs.
                            <br />
                          </p>
                        </div>
                        <div className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-md-12">
                          ...
                          <label htmlFor="checkedA" className="jss84">
                            <div onClick={toggle19}>VRC19</div>
                            <div onClick={toggle19}>VRC69</div>
                          </label>
                        </div>
                        <div
                          className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-sm-6"
                      ...
                      <p id="arc19-1" className="jss36" style={{ display: jss6 }}>
                        <p>VRC19 Docs</p>
                        VRC19 NFTs allow anyone to mint NFTs and update the image at a later date
                        ...
                        <br />
                        <p>
                          VRC Minter was constructed modularly so that users can enter and exit at
                        ...
                        <p>
                          ...
                          the complexity of VRC19 minting is automated. So users can create
                          programmable/upgradeable NFTs without having to deal with hashing hexs and
                          the like.
                        </p>
                        <p>
                          The VRC minter is a highly-experimental application and should be used
                          with caution.
                        </p>
                      </p>
                      <p id="arc69-1" className="jss36" style={{ display: jss7 }}>
                        <p>VRC69 Docs</p>
                        VRC69 NFTs allow anyone to mint NFTs and update the metadata at a later date
                        via asset config transaction. "The goal of these conventions is to make it
                        simpler to display the properties of a given VRC. This VRC differs from VRC3
                        ...
                        are used to store the metadata, this VRC can be applied to existing VRCs."
                        <br />
                        <br />
                        Here are the steps to mint/configure VRC69 NFTs with VRC Minter:
                        <p>Mint VRC69</p>
                        ...
                        <p>6. Choose the quantity of NFTs per VRC.</p>
                    ...
                    <div className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-md-6">
                      ...
                      <p id="arc19-2" className="jss36" style={{ display: jss6 }}>
                        ...
                        <p>
                          10. At this point, you must sign in with your Voi wallet if you have
                          not already. Pera Wallet and MyAlgo are both supported at launch.
                        </p>
                        ...
                        <p>
                          13. Review the NFT details via NFTExplorer, VRC3.xyz, or any other
                          provider that supports VRC19 NFTs.
                        </p>
                        <br />
                        VRC19 Config
                        <p>
                      ...
                      <p id="arc69-2" className="jss36" style={{ display: jss7 }}>
                        Modify VRC69
                        <p>1. Paste your NFT’s VRC number in the Asset Index field.</p>
                        ...
                        <br />
                        And just a reminder! You agree that any information uploaded to VRC Minter
              ...
              >
                ...
                >
                  <div className="footer-flex">
                    ...
                    <h1 style={{color: "white"}}>Powered by Voi Network</h1>

                      <p className="jss50">
                        Voi is a carbon-negative blockchain. <br></br>
