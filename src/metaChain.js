...
//console.log(Pipeline.devGenHash)

const fetchAndParse = async (txid) => {
  let url = 'https://voitest-api.algorpc.pro/v2/transactions/';
          ...
          <div className="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-3">
            <div className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
              ...
              <h6 className="MuiTypography-root MuiTypography-subtitle1">
                On-chain data sharding has arrived <br></br>
                <i>(Testnet only)</i>
              </h6>
              <div id="not-connected"></div>
            </div>
            <Grid item xs={12} sm={4} md={3}>
              <NFTFetch3 onClick={getVoteInfo} txIds={txIds} fileSize={size}></NFTFetch3>
            </Grid>
            <NFTCard2 />
          </div>
        </div>
