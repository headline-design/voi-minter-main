...
const default69 = `{
  "standard": "arc69",
  "description": "VoiLogo for Voi Minter",
  "external_url": "https://voiminter.daotools.org",
  "mime_type": "image/png",
  "properties": {
    "Logo": "VRC",
    "Background": "White",
              ...
              <div className="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-3">
                ...
                >
                  <h1 className="MuiTypography-root jss10 MuiTypography-h1">
                    <span>Voi</span> Minter
                  </h1>
                  <h6 className="MuiTypography-root jss11 MuiTypography-subtitle1">
                    Mint VRC19 and VRC69 NFTs on Voi Network at supersonic speed!
                  </h6>
                </div>
              </div>
            </div>
                ...
                <div className="jss26">
                  <div className="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-3">
                    ...
                    <div className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-md-6">
                      ...
                      <p className="jss36">
                        Once your NFT is minted on the Voi blockchain, you will not be able to
                        ...
                        <br />
                        <br />
                        You agree that any information uploaded to Voi Minter will not contain
                ...
                >
                  <div className="footer-flex">
                    ...
                    <h1 style={{color: "white"}}>Powered by Voi Network</h1>
                      ...
                      <p className="jss50">
                        Voi Network is a carbon-negative blockchain. <br></br>
                        Sustainable, scalable, and decentralized to its core.
                      </p>
                    </div>
        ...
        <div className="container help-container-2">
          <div className="help-text">
            <p style={{ color: '#000 !important' }}>
              <h3>⚠️🚧Voi Minter is an EXPERIMENTAL Dapp</h3>

              <p>
                The Voi Minter NFT minter from HEADLINE is in active development. User experience
                ...
                be dropped from IPFS if not pinned. With that being said Voi Minter is{' '}
