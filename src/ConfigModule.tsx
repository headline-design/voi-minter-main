...
import Pipeline, { sendTxns } from '@pipeline-ui-2/pipeline/index';
...
window.defaultJSON = {
  name: 'VoiLogo',
  description: 'VoiLogo for Voi Minter by HEADLINE',
              ...
              <div className="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-3">
                ...
                >
                  <h1 className="MuiTypography-root jss10 MuiTypography-h1">
                    <span>Voi</span> Config
                  </h1>
                  <h6 className="MuiTypography-root jss11 MuiTypography-subtitle1">
                    Modify VRC19 NFTs with asset config transactions!
                  </h6>
                </div>
              </div>
            </div>
                ...
                >
                  <div className="footer-flex">
                    ...
                    <h1 style={{color: "white"}}>Powered by Voi Network</h1>
                      ...
                      <p className="jss50">
                        Voi Network is a carbon-negative blockchain.{' '}
