...
class NFTFetch2 extends Component {
  ...
  asaToIpfsJSON = async () => {
    ...
    let asaData = await fetch('https://voitest-idx.algorpc.pro/v2/assets/' + assetId);
  ...
  render() {
    return (
      <div className="jss16">
        ...
        <input className="metadata-object" type="number" defaultValue={747612709} id="assetIndex" />
        <div id="fetchButton">
          <button
